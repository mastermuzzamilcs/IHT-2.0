...
{
    public partial class ctrlParentHome : UserControl
    {
        public ctrlParentHome()
        {
            InitializeComponent();
        }
        public Roles homeParentObj = new Roles();
        public List<string> Notices { get; set; }
        private void ctrlParentHome_Load(object sender, EventArgs e)
        {
            load();
        }
        public void load()
        {
            lblHeadingName.Text = homeParentObj.Name;
